...
import com.example.basic.concurrence.thread.CompareAndSwap;
import com.example.basic.concurrence.thread.DataBuffer;
import com.example.basic.concurrence.thread.MyThread;
...
public class ThreadTest {
    ...
    /**
     * 通过FutureTask实现，因为FutureTask实现了RunnableFuture接口，而RunnableFuture接口继承了Runnable接口，所以FutureTask对象可以传入Thread创建线程
    ...
    /**
     * 通过线程池execute方法执行不带返回值的线程，submit方法执行带返回值的线程
     * @throws ExecutionException
     * @throws InterruptedException
     */
    @Test
